...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .wrap { max-width: none; margin: 0; padding: 20px clamp(14px, 2.2vw, 36px) 96px; }  /* fill the screen - no empty side margins */
  ...
  nav.top select {
    font: 400 0.8125rem "Source Sans 3", sans-serif; color: var(--ink);
    background: var(--surface); border: 1px solid var(--line);
    border-radius: 7px; padding: 6px 9px;
  }
  .nav-label {
    font-family: "IBM Plex Mono", monospace; font-size: 0.6562rem; letter-spacing: .08em;
  ...
  .stat b {
    ...
    font-size: 1.4375rem; font-weight: 500; line-height: 1.15;
  }
  .stat span {
    font-size: 0.6562rem; letter-spacing: .07em; text-transform: uppercase; color: var(--muted);
  ...
  .plegend { display: flex; flex-wrap: wrap; gap: 16px; margin-top: 8px;
             font-size: 0.7812rem; color: var(--muted); font-family: "IBM Plex Mono", monospace; }
  ...
  .sec-head h2 { font-size: 0.9062rem; font-weight: 700; letter-spacing: .06em; text-transform: uppercase; }
  .sec-head .count { font-family: "IBM Plex Mono", monospace; font-size: 0.7812rem; color: var(--muted); }
  .sec-note { color: var(--muted); font-size: 0.8438rem; margin: -4px 0 14px; }
  ...
  .card h3 { font-size: 0.75rem; letter-spacing: .07em; text-transform: uppercase;
             color: var(--muted); margin-bottom: 9px; font-weight: 700; }

  .pills { display: flex; flex-wrap: wrap; gap: 5px; }
  .pill {
    font-family: "IBM Plex Mono", monospace; font-size: 0.6875rem; letter-spacing: .03em;
  ...
  .job-rank { font-family: "IBM Plex Mono", monospace; font-size: 0.9375rem; color: var(--muted); }
  .job-title { font-family: Archivo, sans-serif; font-weight: 600; font-size: 0.9688rem; line-height: 1.3; }
  .job-title a { color: var(--ink); text-decoration: none; }
  .job-title a:hover { color: var(--accent); text-decoration: underline; }
  .job-company { color: var(--muted); font-size: 0.8438rem; margin-top: 1px; }
  .job-score { font-family: "IBM Plex Mono", monospace; font-size: 1.0625rem; color: var(--accent); text-align: right; }
  .job-score small { display: block; font-size: 0.5938rem; letter-spacing: .06em;
                     text-transform: uppercase; color: var(--muted); }
  .job-summary { margin: 9px 0 0; font-size: 0.875rem; }
  .job-meta { color: var(--muted); font-size: 0.8125rem; margin-top: 5px; }
  details.jd { margin-top: 10px; }
  details.jd > summary {
    cursor: pointer; font: 500 0.7812rem/1 "IBM Plex Mono", monospace;
  ...
  .jd-text {
    white-space: pre-wrap; font-size: 0.8438rem; line-height: 1.6; color: var(--ink);
    background: var(--surface-2); border: 1px solid var(--line); border-radius: 8px;
    padding: 13px 15px; margin-top: 4px;  /* grows with the page: no scroll inside the scroll */
  }

  /* --- skill matrix ---------------------------------------------------- */
  .matrix { overflow-x: auto; }
  table.skills { width: 100%; border-collapse: collapse; font-size: 0.8438rem; min-width: 620px; }
  table.skills th {
    text-align: left; font-family: "IBM Plex Mono", monospace; font-size: 0.6562rem;
  ...
  .bar .n { font-family: "IBM Plex Mono", monospace; font-size: 0.75rem;
            color: var(--muted); font-variant-numeric: tabular-nums; white-space: nowrap; }
  .skill-name { font-weight: 600; }
  .evidence { color: var(--muted); font-size: 0.7812rem; }

  /* --- toolbar --------------------------------------------------------- */
  .bar-tools {
    position: sticky; top: 0; z-index: 20; background: var(--bg);
    display: flex; flex-wrap: wrap; gap: 6px; align-items: center;
    padding: 6px 0; border-bottom: 1px solid var(--line); margin-bottom: 10px;
  }
  .chip {
    font: 500 0.8125rem/1 Archivo, sans-serif; border: 1px solid var(--line);
  ...
  .picker { max-width: 230px; }
  .ghost {
    font: 500 0.7812rem/1 Archivo, sans-serif; border: 1px solid var(--line);
    background: var(--surface); color: var(--muted);
    padding: 5px 9px; border-radius: 8px; cursor: pointer;
  }
  /* short windows: the toolbar scrolls away with the page instead of covering it */
  @media (max-height: 760px) { .bar-tools, .bar { position: static; } }
  ...
  .q-num {
    font-family: "IBM Plex Mono", monospace; font-size: 0.8125rem; color: var(--muted);
    font-variant-numeric: tabular-nums; padding-top: 2px;
  }
  .q-text {
    font-family: Archivo, sans-serif; font-weight: 600; font-size: 0.9688rem; line-height: 1.4;
  ...
  .q-why { color: var(--muted); font-size: 0.7812rem; margin-top: 7px; }

  .q-answer {
    margin: 0 16px 14px 80px; padding: 13px 15px; border-radius: 8px;
    background: var(--surface-2); border: 1px solid var(--line);
    font-size: 0.8875rem; line-height: 1.62;
  }
  ...
  .q-answer pre {
    ...
    background: var(--surface); border: 1px solid var(--line);
    font: 400 0.7875rem/1.6 "IBM Plex Mono", ui-monospace, monospace; white-space: pre;
  }
  .q-answer code {
  ...
  .q-answer .lead {
    display: block; font-family: "IBM Plex Mono", monospace; font-size: 0.6562rem;
  ...
  .q-answer .link {
    ...
    color: var(--muted); font-size: 0.8rem; white-space: normal;
  }
  ...
  .jump button {
    font: 500 0.7812rem/1 Archivo, sans-serif; border: none; background: transparent;
  ...
  footer .checks { margin-top: 8px; font-family: "IBM Plex Mono", monospace; font-size: 0.75rem; }
