...
| `site/` | Phone page on GitHub Pages: start a worldwide search from your phone (runs on GitHub Actions) and read all reports, encrypted. See `site/README.md`; auto-apply from the phone is explained in `AUTO_APPLY.md`. |
